...
/* node_modules\svelte-routing\src\Router.svelte generated by Svelte v3.32.0 */
...
/* node_modules\svelte-routing\src\Route.svelte generated by Svelte v3.32.0 */
...
/* node_modules\svelte-routing\src\Link.svelte generated by Svelte v3.32.0 */
...
/* src\components\NavLink.svelte generated by Svelte v3.32.0 */
...
/* src\routes\Home.svelte generated by Svelte v3.32.0 */

const Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	let { sprops } = $$props;
	if ($$props.sprops === void 0 && $$bindings.sprops && sprops !== void 0) $$bindings.sprops(sprops);

	return `<div class="${"row"}"><div class="${"col"}"><h1 class="${"text-center"}">${escape(sprops)}</h1></div></div>
<div class="${"row"}"><div class="${"col "}"><p>Welcome to my website</p></div>
  <div class="${"col"}">right side</div></div>`;
});

/* src\routes\About.svelte generated by Svelte v3.32.0 */
...
/* src\routes\Blog.svelte generated by Svelte v3.32.0 */
...
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${validate_component(Router, "Router").$$render($$result, { url }, {}, {
		default: () => `<nav class="${"navbar navbar-expand-lg navbar-light bg-light"}"><div class="${"container-fluid"}"><a href="${"."}" class="${"navbar-brand"}">${escape(title)}</a>
      <button class="${"navbar-toggler"}" type="${"button"}" data-bs-toggle="${"collapse"}" data-bs-target="${"#navbarNav"}" aria-controls="${"navbarNav"}" aria-expanded="${"false"}" aria-label="${"Toggle navigation"}"><span class="${"navbar-toggler-icon"}"></span></button>
      <div class="${"collapse navbar-collapse"}" id="${"navbarNav"}"><ul class="${"navbar-nav"}"><li class="${"nav-item"}">${validate_component(NavLink, "NavLink").$$render($$result, { to: "/" }, {}, { default: () => `Home` })}</li>
          <li class="${"nav-item"}">${validate_component(NavLink, "NavLink").$$render($$result, { to: "about" }, {}, { default: () => `About` })}</li>
          <li class="${"nav-item"}">${validate_component(NavLink, "NavLink").$$render($$result, { to: "blog" }, {}, { default: () => `Blog` })}</li></ul></div></div></nav>
  <div><div class="${"container-fluid"}">${validate_component(Route, "Route").$$render($$result, { path: "about", component: About, sprops }, {}, {})}
      ${validate_component(Route, "Route").$$render($$result, { path: "blog/*", component: Blog, sprops }, {}, {})}
      ${validate_component(Route, "Route").$$render($$result, { path: "/", component: Home, sprops }, {}, {})}</div></div>`
	})}`;
});
